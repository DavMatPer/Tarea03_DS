...
public class NotificacionMensajeTest {
     ...
     *
     * CORREGIDO: la clase "Notificación" referenciada en el plan original no existe;
     * el nombre real es NotificacionMensaje. Además, solo "contenido" tiene accesor
     * público ("asunto" no tiene getter/setter).
     */
    @Test
