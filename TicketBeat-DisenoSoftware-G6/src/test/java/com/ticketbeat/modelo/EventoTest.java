...
public class EventoTest {
     ...
     *
     * CORREGIDO: ArrayList.add(null) es válido en Java; no lanza NullPointerException.
     * El boleto nulo se agrega silenciosamente a la lista, revelando la falta de
     * validación de entrada (no la excepción que afirmaba el plan original).
     */
    @Test
